    ...
    for name in sorted(all_data_loaders, key=custom_key):
        ...
        if table_type == "TotalRMSE":
            table.add_row(
                [
                    name,
                    f"{metrics['rmse_e'] * 1000:.2f}",
                    f"{metrics['rmse_f'] * 1000:.2f}",
            ...
            table.add_row(
                [
                    name,
                    f"{metrics['rmse_e_per_atom'] * 1000:.2f}",
                    f"{metrics['rmse_f'] * 1000:.2f}",
                    f"{metrics['rel_rmse_f']:.2f}",
                ]
            )
            ...
            table.add_row(
                [
                    ...
                    f"{metrics['rmse_f'] * 1000:.2f}",
                    f"{metrics['rel_rmse_f']:.2f}",
                    f"{metrics['rmse_virials'] * 1000:.2f}",
                ]
            )
        elif table_type == "TotalMAE":
            table.add_row(
                [
                    name,
                    f"{metrics['mae_e'] * 1000:.2f}",
                    f"{metrics['mae_f'] * 1000:.2f}",
            ...
            table.add_row(
                [
                    name,
                    f"{metrics['mae_e_per_atom'] * 1000:.2f}",
                    f"{metrics['mae_f'] * 1000:.2f}",
                    f"{metrics['rel_mae_f']:.2f}",
                ]
            )
